  ...
  plugins: [
    ...
    Unocss({
      shortcuts: [
        ...
        ['bg-base', 'dark:bg-gray-900 bg-white'],
        ['form-input', 'py-3 px-4 block w-full shadow-md focus:border-longevity-blue border-gray-300 transition-colors focus:outline-none focus:ring-0 rounded'],
        ['link-text', 'font-medium text-gray-dark hover:text-gray transition-colors underline'],
      ],
      presets: [
        presetUno(),
        presetAttributify(),
