...
<template>
  <footer class="bg-gray-100 dark:bg-gray-700">
    <div class="px-6 pt-6">
      <div class="flex justify-center mb-6 mx-auto">
        ...
        <a href="https://www.linkedin.com/in/kristinpaige/" type="button" class="social-button">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
        ...
        <form action="">
          <div class="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
            ...
            <div class="md:mr-auto mb-6">
              <button type="submit" class="inline-block px-6 py-2 border-2 border-gray-600 text-gray-800 dark:border-white dark:text-white font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2">
        <div class="mb-6">
          ...
          <ul class="list-none mb-0">
            ...
            <li>
              <a href="#!" class="footer-link">Link 4</a>
            </li>
          </ul>
        </div>
  ...
  <nav text-xl mt-6 inline-flex gap-2>
    ...
    <a
      ...
      rel="noreferrer"
      href="https://www.linkedin.com/in/kristinpaige/"
      target="_blank"
      title="LinkedIn"
    />
  </nav>
